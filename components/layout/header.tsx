        ...
        <header className="sticky top-0 z-50 w-full border-b border-slate-200/50 bg-white/80 backdrop-blur-md supports-[backdrop-filter]:bg-white/60 shadow-sm transition-all duration-200">
            <div className="container mx-auto flex h-16 items-center justify-between px-4">
                ...
                <div className="flex items-center gap-2 xl:gap-3 shrink-0">
                    ...
                    <div className="flex items-center bg-slate-100/80 p-0.5 rounded-full border border-slate-200/40 shrink-0">
                        <div className="pl-2 pr-1 text-slate-400 shrink-0">
                            <Globe className="h-3 w-3" />
                        </div>
                        <div className="flex items-center gap-0.5 text-[10px] xl:text-[11px] font-bold shrink-0">
                            {supportedLangs.map((lang) => (
                                <button
                                    key={lang}
                                    onClick={() => changeLanguage(lang)}
                                    className={`px-2 py-0.5 rounded-full transition-all duration-200 whitespace-nowrap shrink-0 ${
                                        currentLang === lang
                    ...
                    <a href="https://wa.me/821055346843" target="_blank" rel="noopener noreferrer" className="hidden xl:inline-flex shrink-0">
                        <Button variant="outline" size="sm" className="gap-1.5 h-8 text-xs rounded-full border-emerald-200 hover:border-emerald-300 bg-emerald-50/50 hover:bg-emerald-50 text-emerald-700 hover:text-emerald-800 shadow-sm transition-all duration-200 whitespace-nowrap shrink-0">
                    ...
                    <Link href={`/${currentLang}#contact`} className="hidden sm:inline-flex shrink-0">
